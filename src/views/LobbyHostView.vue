<template>
  <div class="home">
    <div class="main-content">
      <div class="header">
        <p>Kod: <span style="font-family: monospace;">{{ store.gameId }}</span></p>
        <p>{{ store.username }}</p>
      </div>
        ...
        <n-scrollbar style="max-height: 50vh;">
          <div class="lobby-content">
            ...
            <div class="user-row">
              ...
              <div class="user-card" :class="{ 'host-card': user.isHost}" v-for="(user, idx) in store.players" :key="idx">
      ...
      <div class="bottom-section">
        ...
        <div class="button-side">
          ...
          <n-button type="success" size="large" @click="startQuiz">
            Start
          </n-button>
...
function startQuiz() {
  ...
  store.socket?.emit('game:question:next', store.gameId);
}
